...
import aaa from "../../images/courses/english_Flag.png";
...
const courses = [
  {
    ...
    courseMenu: [
      ...
      {
        menuTitle: "Curricullum",
        menuContent: "Curricullum",
      },
      {
        menuTitle: "Structură",
        menuContent: [
    ...
    <div className="p-5 coursesMainPage-mainDiv">
      <div className="row m-0">
        {courses.map((course, idx) => (
          <div
            key={course.name}
            className="col-md-6 col-lg-4 p-4 coursesMainPage-courseBox"
          >
            ...
            <div className="coursesMainPage-course">
              <div className="m-0 p-0">
                ...
                <img
                  src={require(`../../images/courses/${course.language.toLowerCase()}_Flag.png`)}
                  alt=""
                />
              </div>
